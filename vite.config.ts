...
export default defineConfig({
  ...
  // https://davest-max.github.io/agent-next-gen-v2/, a subpath, not
  ...
  resolve: {
    alias: {
      ...
      "@nicecxone/lyra-ui/styles": path.resolve(__dirname, "./vendor/lyra-ui/src/styles/lyra-tokens.css"),
      ...
      "@nicecxone/lyra-ui/agents-data": path.resolve(__dirname, "./vendor/lyra-ui/src/components/__stories__/create-new-agents-data.ts"),
      "@nicecxone/lyra-ui/customers-data": path.resolve(__dirname, "./vendor/lyra-ui/src/components/__stories__/create-new-customers-data.ts"),
      "@nicecxone/lyra-ui": path.resolve(__dirname, "./vendor/lyra-ui/src/index.ts"),
    },
  },
});
